...
public class DockerContainerManager : IContainerManager
{
    ...
    public async Task<DockerAvailabilityStatus> GetDockerStatusAsync(CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            return DockerAvailabilityStatus.CreateSuccess(versionText, platform);
        }
        catch (OperationCanceledException) when (cancellationToken.IsCancellationRequested)
        {
            throw;
        ...
        catch (Exception ex)
        {
            ...
            return DockerAvailabilityStatus.CreateFailure(type, message);
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (await ImageExistsAsync(image, cancellationToken).ConfigureAwait(false))
            {
